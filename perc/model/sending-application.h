...
#ifndef SENDING_APPLICATION_H
#define SENDING_APPLICATION_H
 ...
 * \defgroup sending SendingApplication
 *
...
public:
  ...
  */
  ...
  // Member functions of xfabric's sending app
  void ChangeRate(DataRate rate);
  // Don't think this is ever used uint32_t GetFlowId(void);
...
private:
  ...
  bool         m_hiPrio; //!<True if packets sent from this socket are all high prio
  /// Traced Callback: transmitted packets.
  TracedCallback<Ptr<const Packet> > m_txTrace;

  // Member variables used in xfabric's sending app
  DataRate        m_dataRate;
  DataRate        m_dataRateFailSafe;  // lav: check copy (what!!?)
  Time            m_connectTime;
private:
  /**
